...
function __privateEnvsDir()
{
  ...
  #INSTALLER DIR
  export STACK_STACK_INSTALLER_DIR=${PWD}/installer
  ...
  export STACK_INSTALLER_DOCKER_SSH_KEYS_DIR=${STACK_INSTALLER_DOCKER_DIR}/sshkeys
...
function __utilPrepareStackEnvsDefault()
{
  ...
  export BUILD_TEMP_APP_CONF_DIR=${BUILD_TEMP_DIR}/conf
  ...
  export APPLICATION_DEPLOY_DATA_DIR=${BUILD_TEMP_APP_DATA_DIR}
  export APPLICATION_DEPLOY_CONF_DIR=${BUILD_TEMP_APP_CONF_DIR}
